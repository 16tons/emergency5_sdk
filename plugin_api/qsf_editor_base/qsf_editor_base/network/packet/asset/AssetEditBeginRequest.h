	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT AssetEditBeginRequest : public qsf::packet::BinaryPacket<AssetEditBeginRequest>
				{
				...
				public:
					...
					*    Default constructor
					*/
					AssetEditBeginRequest();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~AssetEditBeginRequest();
