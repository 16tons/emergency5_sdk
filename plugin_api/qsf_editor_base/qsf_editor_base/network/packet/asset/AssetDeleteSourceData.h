	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT AssetDeleteSourceData : public qsf::packet::BinaryPacket<AssetDeleteSourceData>
				{
				...
				public:
					...
					*    Default constructor
					*/
					AssetDeleteSourceData();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~AssetDeleteSourceData();
