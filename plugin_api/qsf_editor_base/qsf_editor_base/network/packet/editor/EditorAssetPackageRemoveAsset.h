	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT EditorAssetPackageRemoveAsset : public qsf::packet::BinaryPacket<EditorAssetPackageRemoveAsset>
				{
				...
				public:
					...
					*    Default constructor
					*/
					EditorAssetPackageRemoveAsset();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~EditorAssetPackageRemoveAsset();
