	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT EditorProjectDoRelease : public qsf::packet::BinaryPacket<EditorProjectDoRelease>
				{
				...
				public:
					...
					*    Default constructor
					*/
					EditorProjectDoRelease();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~EditorProjectDoRelease();
