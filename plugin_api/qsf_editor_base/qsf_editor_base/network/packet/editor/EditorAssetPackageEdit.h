	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT EditorAssetPackageEdit : public qsf::packet::BinaryPacket<EditorAssetPackageEdit>
				{
				...
				public:
					...
					*    Default constructor
					*/
					EditorAssetPackageEdit();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~EditorAssetPackageEdit();
