	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT EditorAssetUpdateRequest : public qsf::packet::BinaryPacket<EditorAssetUpdateRequest>
				{
				...
				public:
					...
					*    Default constructor
					*/
					EditorAssetUpdateRequest();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~EditorAssetUpdateRequest();
