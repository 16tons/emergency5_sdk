	...
	namespace editor
	{
		namespace base
		{
			namespace packet
			{
				...
				*    TODO(co) Comment
				*/
				class QSF_EDITOR_BASE_API_EXPORT EditorSetMaintenanceMode : public qsf::packet::BinaryPacket<EditorSetMaintenanceMode>
				{
				...
				public:
					...
					*    Default constructor
					*/
					EditorSetMaintenanceMode();

					/**
					*  @brief
					*    Destructor
					*/
					virtual ~EditorSetMaintenanceMode();
