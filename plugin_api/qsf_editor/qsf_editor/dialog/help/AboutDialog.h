...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Abstract QSF editor about dialog base class
		*/
		class QSF_EDITOR_API_EXPORT AboutDialog : public Dialog
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::AboutDialog" unique pluginable dialog ID
		...
		public:
			/**
			*  @brief
			*    Add project specific about dialog menu functionality
			*
			*  @note
			*    - The default implementation is empty
			*/
			virtual void createHelpMenu(QMenu& qMenu);
		...
		protected:
			...
			*/
			AboutDialog(DialogManager* dialogManager, QWidget* qWidgetParent);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::AboutDialog)
