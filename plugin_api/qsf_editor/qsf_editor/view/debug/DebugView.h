...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Abstract debug view base class
		*
		*  @note
		...
		*/
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::DebugView" unique pluginable view ID
		...
		protected:
			...
			*/
			DebugView(ViewManager* viewManager, QWidget* qWidgetParent);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::DebugView)
