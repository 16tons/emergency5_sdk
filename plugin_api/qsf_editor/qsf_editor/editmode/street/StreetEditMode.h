...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Abstract street edit mode base class
		*/
		class StreetEditMode : public NodesEditMode
		{
		...
		protected:
			...
			*/
			explicit StreetEditMode(EditModeManager* editModeManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::StreetEditMode)
