...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Bone link transform edit mode class
		*/
		class QSF_EDITOR_API_EXPORT BoneLinkTransformEditMode : public TransformEditMode
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::BoneLinkTransformEditMode" unique pluginable edit mode ID
		...
		public:
			...
			*/
			explicit BoneLinkTransformEditMode(EditModeManager* editModeManager);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~BoneLinkTransformEditMode();
		...
		private:
			...
			*/
			base::Operation* buildTransformOperation(uint64 entityId, const Transform& startupTransform, const Transform& startupBoneLinkTransform, GizmoComponent::TransformationMode transformMode) const;
		...
		private:
			...
			std::vector<Transform> mStartupBoneLinkTransform;	///< The bone link transform of the selected entities at the point in time the transform edit mode became active
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::BoneLinkTransformEditMode)
