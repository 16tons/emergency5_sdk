...
namespace qsf
{
	namespace editor
	{
		...
		*/
		class NewNodesEditMode : public NodesEditMode
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::NewNodesEditMode" unique pluginable edit mode ID
		...
		public:
			...
			*/
			explicit NewNodesEditMode(EditModeManager* editModeManager);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~NewNodesEditMode();

			/**
			*  @brief
			*    Set the component ID of the concrete nodes component to instantiate
			*
			*  @param[in] componentId
			*    The component ID of the concrete nodes component to instantiate (e.g. "qsf::StringHash("qsf::BlockerPolygonComponent")")
			*/
		...
		//[-------------------------------------------------------]
		private:
			unsigned int mComponentId;			///< The component ID of the concrete nodes component to instantiate (e.g. "qsf::StringHash("qsf::BlockerPolygonComponent")")
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::NewNodesEditMode)
