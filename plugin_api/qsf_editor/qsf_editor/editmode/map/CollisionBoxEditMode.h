...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Collision box edit mode class
		*
		*  @note
		*    - Part of the visual collision box editing
		*/
		class CollisionBoxEditMode : public EditMode
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::CollisionBoxEditMode" unique pluginable edit mode ID
		...
		public:
			...
			*/
			explicit CollisionBoxEditMode(EditModeManager* editModeManager);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~CollisionBoxEditMode();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::CollisionBoxEditMode)
