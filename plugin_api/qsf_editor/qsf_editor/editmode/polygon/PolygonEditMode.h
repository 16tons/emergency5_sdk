...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Abstract polygon edit mode base class
		*/
		class PolygonEditMode : public NodesEditMode
		{
		...
		protected:
			...
			*/
			explicit PolygonEditMode(EditModeManager* editModeManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::PolygonEditMode)
