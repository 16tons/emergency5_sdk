...
namespace qsf
{
	namespace editor
	{
		...
		*/
		class OperationStatusBar : public StatusBar
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::OperationStatusBar" unique pluginable status bar ID
		...
		public:
			...
			*/
			OperationStatusBar(StatusBarManager* statusBarManager, QWidget* qWidgetParent);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~OperationStatusBar();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::OperationStatusBar)
