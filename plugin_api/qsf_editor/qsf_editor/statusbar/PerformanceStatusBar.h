...
namespace qsf
{
	namespace editor
	{
		...
		*/
		class PerformanceStatusBar : public StatusBar
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 PLUGINABLE_ID;	///< "qsf::editor::PerformanceStatusBar" unique pluginable status bar ID
		...
		public:
			...
			*/
			PerformanceStatusBar(StatusBarManager* statusBarManager, QWidget* qWidgetParent);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~PerformanceStatusBar();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(qsf::editor::PerformanceStatusBar)
