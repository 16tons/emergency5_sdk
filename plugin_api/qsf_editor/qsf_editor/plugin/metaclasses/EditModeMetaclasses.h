...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Static CAMP edit mode plugin metaclass collection class
		*/
		class EditModeMetaclasses : public QObject, public Metaclasses
		{
		...
		private:
			...
			*/
			explicit EditModeMetaclasses(qsf::Plugin& plugin);
