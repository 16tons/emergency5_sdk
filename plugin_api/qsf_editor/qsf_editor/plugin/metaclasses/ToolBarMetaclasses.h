...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Static CAMP tool bar plugin metaclass collection class
		*/
		class ToolBarMetaclasses : public QObject, public Metaclasses
		{
		...
		private:
			...
			*/
			explicit ToolBarMetaclasses(qsf::Plugin& plugin);
