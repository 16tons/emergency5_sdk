...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Static CAMP Qt actions plugin metaclass collection class
		*/
		class QActionsMetaclasses : public QObject, public Metaclasses
		{
		...
		private:
			...
			*/
			explicit QActionsMetaclasses(qsf::Plugin& plugin);
