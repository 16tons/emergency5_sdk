...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Static CAMP dialog plugin metaclass collection class
		*/
		class DialogMetaclasses : public QObject, public Metaclasses
		{
		...
		private:
			...
			*/
			explicit DialogMetaclasses(qsf::Plugin& plugin);
