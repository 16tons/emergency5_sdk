...
namespace qsf
{
	namespace editor
	{
		...
		/**
		*  @brief
		*    Naming convention asset issue class
		*/
		class NamingConventionIssue : public LocalAssetIssue
		{
		...
		//[-------------------------------------------------------]
		public:
			static const uint32 ISSUE_ID;	///< string hash of "qsf::editor::NamingConventionIssue"
		...
		//[-------------------------------------------------------]
		public:
			NamingConventionIssue(GlobalAssetId globalAssetId, AssetPackage* assetPackage = nullptr);

			/**
			*  @brief
			*    Destructor
			*/
			virtual ~NamingConventionIssue();
