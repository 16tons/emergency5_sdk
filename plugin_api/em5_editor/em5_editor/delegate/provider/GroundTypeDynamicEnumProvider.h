...
namespace em5
{
	namespace editor
	{
		...
		*/
		class GroundTypeDynamicEnumProvider : public qsf::editor::DynamicEnumProvider
		{
		...
		//[-------------------------------------------------------]
		public:
			static const std::string SEMANTIC_NAME;	///< Enum semantic name "enum:GroundType"
		...
		public:
			...
			*    Constructor
			*/
			explicit GroundTypeDynamicEnumProvider(qsf::editor::DynamicEnumManager* dynamicEnumManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::editor::GroundTypeDynamicEnumProvider)
