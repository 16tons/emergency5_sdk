...
namespace qsf
{
	namespace logic
	{
		...
		*/
		class QSF_LOGIC_API_EXPORT SequenceTrackKeyEntityComponentPropertyQuatEuler : public SequenceTrackKey
		{
		...
		//[-------------------------------------------------------]
		public:
			explicit SequenceTrackKeyEntityComponentPropertyQuatEuler(uint32 frameNumber) :
			...
			void setValue(const glm::quat& quat);
		...
		*/
		class QSF_LOGIC_API_EXPORT SequenceTrackEntityComponentPropertyQuatEuler : public SequenceTrackEntityComponentProperty
		{
		...
		//[-------------------------------------------------------]
		public:
			SequenceTrackEntityComponentPropertyQuatEuler(Sequence* sequence, uint32 id);
			virtual ~SequenceTrackEntityComponentPropertyQuatEuler();
		...
		//[-------------------------------------------------------]
		private:
			typedef std::vector<SequenceTrackKeyEntityComponentPropertyQuatEuler*> KeyList;
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE(qsf::logic::SequenceTrackKeyEntityComponentPropertyQuatEuler)
QSF_CAMP_TYPE_NONCOPYABLE(qsf::logic::SequenceTrackEntityComponentPropertyQuatEuler)
