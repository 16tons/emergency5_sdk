...
namespace qsf
{
	namespace logic
	{
		...
		/**
		*  @brief
		*    Static CAMP sequencer plugin metaclass collection class
		*/
		class SequencerMetaclasses : public Metaclasses
		{
		...
		private:
			...
			*/
			explicit SequencerMetaclasses(Plugin& plugin);
