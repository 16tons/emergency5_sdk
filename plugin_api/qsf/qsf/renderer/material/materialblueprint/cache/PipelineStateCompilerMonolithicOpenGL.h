...
namespace qsf
{
	...
	/**
	*  @brief
	*    OpenGL pipeline state compiler class for monolithic programs (legacy approach)
	*/
	class PipelineStateCompilerMonolithicOpenGL : public PipelineStateCompiler
	{
	...
	public:
		struct CompilerRequestOpenGL : public CompilerRequest
		{
			...
			uint32							   glProgramHandle;	///< "GLuint" (we don't want to include OpenGL headers in here)
	...
	protected:
		...
		*    Default constructor
		*/
		PipelineStateCompilerMonolithicOpenGL();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~PipelineStateCompilerMonolithicOpenGL();
