...
namespace qsf
{
	...
	*/
	class QSF_API_EXPORT DecalProjectedMeshGenerator : public MeshGenerator
	{
	...
	//[ Friends                                               ]
	//[-------------------------------------------------------]
		friend class DecalProjectedComponent;
	...
	public:
		...
		*/
		bool createMesh(const std::string& ogreMeshName, DecalProjectedComponent& decalGeometricComponent);
