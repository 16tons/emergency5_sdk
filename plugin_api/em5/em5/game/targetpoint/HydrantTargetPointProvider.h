...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT HydrantTargetPointProvider : public qsf::logic::TargetPointProvider
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 TARGET_POINT_ID;	///< "HydrantTargetPointProvider" unique identifier
	...
	public:
		...
		*    Constructor
		*/
		explicit HydrantTargetPointProvider(qsf::logic::TargetPointManager* manager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::HydrantTargetPointProvider)
