...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT ApproachBoatDropPointTargetPointProvider : public qsf::logic::TargetPointProvider
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 TARGET_POINT_ID;	///< "ApproachBoatDropPointTargetPointProvider" unique identifier
	...
	public:
		...
		*    Constructor
		*/
		explicit ApproachBoatDropPointTargetPointProvider(qsf::logic::TargetPointManager* manager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::ApproachBoatDropPointTargetPointProvider)
