...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT PickupRobotByTransporterTargetPointProvider : public qsf::logic::TargetPointProvider
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 TARGET_POINT_ID;		///< "PickupRobotByTransporterTargetPointProvider" unique identifier
	...
	public:
		...
		*    Constructor
		*/
		explicit PickupRobotByTransporterTargetPointProvider(qsf::logic::TargetPointManager* manager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PickupRobotByTransporterTargetPointProvider)
