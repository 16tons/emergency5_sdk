...
namespace em5
{
	...
	/**
	*  @brief
	*    Static CAMP vehicle component plugin metaclass collection class
	*/
	class VehicleComponentMetaclasses : public qsf::Metaclasses
	{
	...
	private:
		...
		*/
		explicit VehicleComponentMetaclasses(qsf::Plugin& plugin);
