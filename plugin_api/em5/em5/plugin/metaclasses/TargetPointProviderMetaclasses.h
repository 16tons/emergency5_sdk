...
namespace em5
{
	...
	/**
	*  @brief
	*    Static CAMP game logic plugin metaclass collection class
	*/
	class TargetPointProviderMetaclasses : public qsf::Metaclasses
	{
	...
	private:
		...
		*/
		explicit TargetPointProviderMetaclasses(qsf::Plugin& plugin);
		...
		*/
		~TargetPointProviderMetaclasses();
