...
namespace em5
{
	...
	/**
	*  @brief
	*    Static CAMP game object component plugin metaclass collection class
	*/
	class GameObjectComponentMetaclasses : public qsf::Metaclasses
	{
	...
	private:
		...
		*/
		explicit GameObjectComponentMetaclasses(qsf::Plugin& plugin);
		...
		*/
		~GameObjectComponentMetaclasses();
