...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 freeplay event factory for "Weapon deal event" (sometimes called drugdeal event)
	*/
	class EM5_API_EXPORT WeaponDealEventFactory : public FreeplayEventFactory
	{
	...
	public:
		...
		*    Default constructor
		*/
		WeaponDealEventFactory();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~WeaponDealEventFactory();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::WeaponDealEventFactory)
