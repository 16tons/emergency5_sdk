...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 freeplay event factory for "robbery"
	*/
	class EM5_API_EXPORT RobberyEventFactory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::RobberyEventFactory)
