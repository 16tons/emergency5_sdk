...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT Arsonist02EventFactory : public FreeplayEventFactory
	{
	...
	public:
		...
		*    Default constructor
		*/
		Arsonist02EventFactory();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~Arsonist02EventFactory();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::Arsonist02EventFactory)
