...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 freeplay event factory for "train accident event"
	*/
	class EM5_API_EXPORT TrainAccidentEventFactory : public FreeplayEventFactory
	{
	...
	public:
		...
		*    Default constructor
		*/
		TrainAccidentEventFactory();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~TrainAccidentEventFactory();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::TrainAccidentEventFactory)
