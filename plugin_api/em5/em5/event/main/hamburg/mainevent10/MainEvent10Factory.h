...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 10 factory "Plane Crash"
	*/
	class MainEvent10Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent10Factory)
