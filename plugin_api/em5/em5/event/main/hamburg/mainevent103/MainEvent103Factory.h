...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 02 factory "Hamburg"
	*/
	class MainEvent103Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent103Factory)
