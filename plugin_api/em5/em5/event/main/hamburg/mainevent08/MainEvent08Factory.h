...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 08 factory "Flood"
	*/
	class MainEvent08Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent08Factory)
