...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 06 factory "----"
	*/
	class MainEvent06Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent06Factory)
