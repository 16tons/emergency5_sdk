...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 101 factory "Cologne"
	*/
	class MainEvent101Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent101Factory)
