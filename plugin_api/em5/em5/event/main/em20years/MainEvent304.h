...
namespace em5
{
	...
	*/
	class MainEvent304 : public Em20MainEventBase
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 FREEPLAY_EVENT_ID;		///< "em5::MainEvent304" unique freeplay event ID
	...
	private:
		...
		void switchTrafficLight(bool setGreen);
	...
	private:
		...
		qsf::WeakPtr<qsf::Entity> mTrafficLightController;
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent304)
