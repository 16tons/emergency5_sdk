...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 14 factory "----"
	*/
	class MainEvent14Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent14Factory)
