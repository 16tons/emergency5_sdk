...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 02 factory "----"
	*/
	class MainEvent104Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent104Factory)
