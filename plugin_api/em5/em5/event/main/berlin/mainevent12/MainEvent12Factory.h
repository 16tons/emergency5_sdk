...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 main event 12 factory "----"
	*/
	class MainEvent12Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent12Factory)
