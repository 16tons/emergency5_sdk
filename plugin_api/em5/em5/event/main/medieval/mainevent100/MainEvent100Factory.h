...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 2016 main event 100 factory
	*/
	class MainEvent100Factory : public FreeplayEventFactory
	{
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::MainEvent100Factory)
