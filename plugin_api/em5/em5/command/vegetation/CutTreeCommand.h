...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 cut tree command
	*/
	class CutTreeCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::CutTreeCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit CutTreeCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::CutTreeCommand)
