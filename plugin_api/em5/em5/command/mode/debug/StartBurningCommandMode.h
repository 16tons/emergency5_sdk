...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT StartBurningCommandMode : public DebugCommandMode
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::StartBurningCommandMode" unique command pluginable ID
	...
	public:
		...
		*    Default constructor
		*/
		StartBurningCommandMode();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~StartBurningCommandMode();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::StartBurningCommandMode)
