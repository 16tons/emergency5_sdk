...
namespace em5
{
	...
	*/
	class ExtinguishWithHoseCommand : public ExtinguishCoolBaseCommand
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::ExtinguishWithHoseCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit ExtinguishWithHoseCommand(qsf::game::CommandManager* commandManager);
		explicit ExtinguishWithHoseCommand(qsf::game::CommandManager* commandManager, uint32 commandId);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::ExtinguishWithHoseCommand)
