...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 lay down drowning person from boat command
	*/
	class PlacePersonFromBoatCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PlacePersonFromBoatCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PlacePersonFromBoatCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PlacePersonFromBoatCommand)
