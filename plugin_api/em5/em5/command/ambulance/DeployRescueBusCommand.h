...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 deploy rescue bus command
	*/
	class DeployRescueBusCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::DeployRescueBusCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit DeployRescueBusCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::DeployRescueBusCommand)
