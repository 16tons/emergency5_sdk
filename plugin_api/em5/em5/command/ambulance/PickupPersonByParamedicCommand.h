...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 pickup person by paramedic command
	*/
	class PickupPersonByParamedicCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PickupPersonByParamedicCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PickupPersonByParamedicCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PickupPersonByParamedicCommand)
