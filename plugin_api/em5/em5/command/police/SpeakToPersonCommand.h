...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 speak to person command
	*/
	class SpeakToPersonCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::SpeakToPersonCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit SpeakToPersonCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::SpeakToPersonCommand)
