...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 send police dog attacking gangster command
	*/
	class SendPoliceDogAttackCommand : public SendDogForSearchCommand
	{
	...
	public:
		...
		*    Constructor
		*/
		explicit SendPoliceDogAttackCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::SendPoliceDogAttackCommand)
