...
namespace em5
{
	...
	*/
	class ArrestGangsterCommand : public Command
	{
	...
	public:
		...
		*    Constructor
		*/
		explicit ArrestGangsterCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::ArrestGangsterCommand)
