...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 stop guide person command
	*/
	class StopGuidePersonCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::StopGuidePersonCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit StopGuidePersonCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::StopGuidePersonCommand)
