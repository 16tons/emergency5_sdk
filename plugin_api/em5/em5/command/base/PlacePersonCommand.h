...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 place person command
	*/
	class PlacePersonCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PlacePersonCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PlacePersonCommand(qsf::game::CommandManager* commandManager);
	...
	//[-------------------------------------------------------]
	private:
		bool checkMatchPersonForVehicle(qsf::Entity* carriedPerson, qsf::Entity* vehicle) const;
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PlacePersonCommand)
