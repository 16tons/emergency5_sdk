...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 boat logic ("Motorboat")
	*/
	class EM5_API_EXPORT BoatLogic : public qsf::GameLogic
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::BoatLogic" game logic type ID
	...
	private:
		...
		bool rescuePersonAutomatism();
		bool placePersonAutomatism();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::BoatLogic)
