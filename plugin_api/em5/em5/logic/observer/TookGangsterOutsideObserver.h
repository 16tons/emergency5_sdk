...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 logic observer gangster was taken outside
	*
	*  @note
	*    - This observer is listening to the attack building message
	*    - If the person was taken outside it increases the objective number and dies
	*/
	class EM5_API_EXPORT TookGangsterOutsideObserver : public Observer
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::TookGagsterOutsideObserver" game logic type ID
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::TookGangsterOutsideObserver)
