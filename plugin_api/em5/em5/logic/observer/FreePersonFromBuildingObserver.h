...
namespace em5
{
	...
	*
	*  @note
	*    - This observer is listening to the "FreePersonFromBuilding" message
	*    - If the person was freed from the building it increases the objective number and runs away
	*/
	class EM5_API_EXPORT FreePersonFromBuildingObserver : public MessageObjectiveObserver
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::FreePersonFromBuildingObserver" game logic type ID
	...
	public:
		...
		*    Default constructor
		*/
		FreePersonFromBuildingObserver();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::FreePersonFromBuildingObserver)
