...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT DestroyedByFireObserver : public Observer
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::DestroyedByFireObserver" game logic type ID
	...
	//[-------------------------------------------------------]
	private:
		void onStoppedBurning(const qsf::MessageParameters& parameters);
		void onDestroyedByFire();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::DestroyedByFireObserver)
