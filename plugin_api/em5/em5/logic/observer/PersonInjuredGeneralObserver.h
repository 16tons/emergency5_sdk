...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 logic general observer person injured
	*
	*  @note
	*    - This observers listens to the person injured message
	*/
	class EM5_API_EXPORT PersonInjuredGeneralObserver : public Observer
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::PersonInjuredGeneralObserver" game logic type ID
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PersonInjuredGeneralObserver)
