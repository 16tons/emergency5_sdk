...
namespace em5
{
	...
	*    - If the entity is transported it increases the objective number and dies
	*/
	class EM5_API_EXPORT GangsterEscapedObserver : public MessageObjectiveObserver
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 GAMELOGIC_TYPE_ID;	// "em5::GangsterEscapedObserver" game logic type ID
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::GangsterEscapedObserver)
