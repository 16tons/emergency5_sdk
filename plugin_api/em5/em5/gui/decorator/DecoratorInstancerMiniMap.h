...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 mini-map decorator instancer
	*
	*  @note
	...
	*/
	class DecoratorInstancerMiniMap : public Rocket::Core::DecoratorInstancer
	{
	...
	public:
		...
		*    Default constructor
		*/
		inline DecoratorInstancerMiniMap();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~DecoratorInstancerMiniMap();
...
//[ Implementation                                        ]
//[-------------------------------------------------------]
#include "em5/gui/decorator/DecoratorInstancerMiniMap-inl.h"
