...
namespace em5
{
	...
	*/
	class HelicopterFollowCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::HelicopterFollowCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit HelicopterFollowCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::HelicopterFollowCommand)
