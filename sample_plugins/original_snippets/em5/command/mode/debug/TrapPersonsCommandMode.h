...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT TrapPersonsCommandMode : public DebugCommandMode
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::TrapPersonsCommandMode" unique command pluginable ID
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::TrapPersonsCommandMode)
