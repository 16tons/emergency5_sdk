...
namespace em5
{
	...
	*/
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::UseEquipmentCommandMode" unique command pluginable ID
	...
	public:
		...
		*    Default constructor
		*/
		UseEquipmentCommandMode();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~UseEquipmentCommandMode();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::UseEquipmentCommandMode)
