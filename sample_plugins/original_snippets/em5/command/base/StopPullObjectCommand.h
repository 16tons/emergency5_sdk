...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 stop pull object command
	*/
	class StopPullObjectCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::StopPullObjectCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit StopPullObjectCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::StopPullObjectCommand)
