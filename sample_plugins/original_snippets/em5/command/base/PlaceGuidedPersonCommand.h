...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 place guided person command
	*/
	class PlaceGuidedPersonCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PlaceGuidedPersonCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PlaceGuidedPersonCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PlaceGuidedPersonCommand)
