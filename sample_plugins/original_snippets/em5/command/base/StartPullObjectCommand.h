...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 start pull object command
	*/
	class StartPullObjectCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::StartPullObjectCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit StartPullObjectCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::StartPullObjectCommand)
