...
namespace em5
{
	...
	*/
	class ExtinguishWithExtinguisherCommand : public ExtinguishCoolBaseCommand
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::ExtinguishWithExtinguisherCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit ExtinguishWithExtinguisherCommand(qsf::game::CommandManager* commandManager);
		explicit ExtinguishWithExtinguisherCommand(qsf::game::CommandManager* commandManager, uint32 commandId);
	...
	private:
		...
		*/
		bool isQueueingCommand(qsf::Entity& firefighterEntity);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::ExtinguishWithExtinguisherCommand)
