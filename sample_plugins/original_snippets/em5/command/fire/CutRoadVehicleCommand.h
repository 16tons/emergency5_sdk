...
namespace em5
{
	...
	*/
	class CutRoadVehicleCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::CutRoadVehicleCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit CutRoadVehicleCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::CutRoadVehicleCommand)
