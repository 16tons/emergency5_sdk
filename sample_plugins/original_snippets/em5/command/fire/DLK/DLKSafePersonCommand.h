...
namespace em5
{
	...
	*/
	class DLKSafePersonCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::DLKSavePersonCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit DLKSafePersonCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::DLKSafePersonCommand)
