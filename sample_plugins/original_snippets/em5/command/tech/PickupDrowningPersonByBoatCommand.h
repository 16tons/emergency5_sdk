...
namespace em5
{
	...
	*/
	class PickupDrowningPersonByBoatCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PickupDrowningPersonByBoatCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PickupDrowningPersonByBoatCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PickupDrowningPersonByBoatCommand)
