...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 plague quick test command
	*/
	class PlagueQuickTestCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::PlagueQuickTestCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit PlagueQuickTestCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PlagueQuickTestCommand)
