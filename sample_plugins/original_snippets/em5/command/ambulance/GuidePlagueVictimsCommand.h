...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 guide plague victims command
	*/
	class GuidePlagueVictimsCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::GuidePlagueVictimsCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit GuidePlagueVictimsCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::GuidePlagueVictimsCommand)
