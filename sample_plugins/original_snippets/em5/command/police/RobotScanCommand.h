...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 robot scan command
	*/
	class RobotScanCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::RobotScanCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit RobotScanCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::RobotScanCommand)
