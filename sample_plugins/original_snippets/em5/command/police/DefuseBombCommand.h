...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 defuse bomb command
	*/
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::DefuseBombCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit DefuseBombCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::DefuseBombCommand)
