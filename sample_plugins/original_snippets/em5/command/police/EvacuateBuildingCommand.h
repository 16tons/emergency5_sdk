...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 evacuate building command
	*/
	class EvacuateBuildingCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::EvacuateBuildingCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit EvacuateBuildingCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::EvacuateBuildingCommand)
