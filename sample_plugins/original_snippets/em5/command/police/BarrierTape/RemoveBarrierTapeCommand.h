...
namespace em5
{
	...
	*/
	class RemoveBarrierTapeCommand : public Command
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 PLUGINABLE_ID;	///< "em5::RemoveBarrierTapeCommand" unique command pluginable ID
	...
	public:
		...
		*    Constructor
		*/
		explicit RemoveBarrierTapeCommand(qsf::game::CommandManager* commandManager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::RemoveBarrierTapeCommand)
