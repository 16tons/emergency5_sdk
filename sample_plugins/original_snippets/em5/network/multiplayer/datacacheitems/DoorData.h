...
namespace em5
{
	namespace multiplayer
	{
		...
		/**
		*  @brief
		*    EMERGENCY 5 entity with a door component data cache for a single entity for multiplayer
		*/
		class DoorData : public DataCacheBase
		{
		...
		//[-------------------------------------------------------]
		public:
			DoorData(const qsf::Entity& targetEntity);
			virtual ~DoorData();
		...
		//[-------------------------------------------------------]
		private:
			qsf::WeakPtr<DoorComponent> mComponent;
			bool	mOpenDoor;
