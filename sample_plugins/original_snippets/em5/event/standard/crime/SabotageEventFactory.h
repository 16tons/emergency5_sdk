...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 freeplay event factory for "Sabotage event"
	*/
	class EM5_API_EXPORT SabotageEventFactory : public FreeplayEventFactory
	{
	...
	public:
		...
		*    Default constructor
		*/
		SabotageEventFactory();

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~SabotageEventFactory();
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::SabotageEventFactory)
