...
namespace em5
{
	...
	/**
	*  @brief
	*    EMERGENCY 5 freeplay event class for "Pickpocket"
	*/
	class EM5_API_EXPORT PickpocketEvent : public GangsterEvent
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 FREEPLAY_EVENT_ID;		///< "em5::PickpocketEvent" unique freeplay event ID
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::PickpocketEvent)
