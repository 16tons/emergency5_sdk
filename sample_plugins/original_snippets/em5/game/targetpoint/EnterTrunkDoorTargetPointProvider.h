...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT EnterTrunkDoorTargetPointProvider : public qsf::logic::TargetPointProvider
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 TARGET_POINT_ID;	///< "EnterTrunkDoorTargetPointProvider" unique identifier
	...
	public:
		...
		*    Constructor
		*/
		explicit EnterTrunkDoorTargetPointProvider(qsf::logic::TargetPointManager* manager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::EnterTrunkDoorTargetPointProvider)
