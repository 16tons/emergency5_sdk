...
namespace em5
{
	...
	*/
	class EM5_API_EXPORT LeadPersonTargetPointProvider : public qsf::logic::TargetPointProvider
	{
	...
	//[-------------------------------------------------------]
	public:
		static const uint32 TARGET_POINT_ID;	///< "LeadPersonTargetPointProvider" unique identifier
	...
	public:
		...
		static glm::vec3 getOffset(qsf::Entity& target);
	...
	public:
		...
		*    Constructor
		*/
		explicit LeadPersonTargetPointProvider(qsf::logic::TargetPointManager* manager);
...
//[ CAMP reflection system                                ]
//[-------------------------------------------------------]
QSF_CAMP_TYPE_NONCOPYABLE(em5::LeadPersonTargetPointProvider)
